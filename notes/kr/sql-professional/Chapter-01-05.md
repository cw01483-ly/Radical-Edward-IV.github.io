...
aside:
  toc: true
mermaid: true
excerpt: 식별자는 데이터베이스에서 엔터티를 고유하게 구별하는 키입니다. 주요 유형으로는 기본 키, 대체 키, 외래 키가 있으며 각각의 역할과 특성을 이해하는 것이 중요합니다. 주식별자는 엔터티 내에서 유일성을 보장하며 후보 식별자는 여러 개의 후보 중 선택됩니다. 복합 식별자는 여러 속성을 조합하여 유일성을 제공합니다. SQLP 시험 준비에 필수적인 개념으로 SQL 전문가에게 매우 유용합니다.
keywords: "식별자, SQL 전문가, SQLP 시험 준비, 데이터베이스 식별자, 기본 키, 대체 키, 외래 키, 주식별자, 후보 식별자, 복합 식별자"
---
...
<figure>
<img src="/notes/assets/sql-professional/normalization-1nf-01.png" width="500px;" alt="다중값">
<figcaption>다중값</figcaption>
</figure>

<figure>
<img src="/notes/assets/sql-professional/normalization-1nf-02.png" width="500px;" alt="">
...
<img src="/notes/assets/sql-professional/normalization-2nf.png" width="500px;" alt="제2정규형">
...
<img src="/notes/assets/sql-professional/normalization-3nf.png" width="500px;" alt="제3정규형">
