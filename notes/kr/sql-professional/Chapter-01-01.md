...
- **단순화:** 복잡한 현실세계를 제한된 표기법으로 표현하여 누구나 쉽게 이해할 수 있도록 함.

- **명확화:** 표현 대상의 애매모호함을 제거함.
...
- **가시화:** 시스템의 현재 또는 목표로 하는 모습을 드러나게 한다.

- **구조화한 틀:** 시스템의 구조를 파악할 수 있게 한다.

- **문서화:** 문서화된 자료가 만들어져 필요한 정보를 전달할 수 있게 한다.

- **간결한 표현:** 세부 사항을 숨겨 필요한 영역에 집중할 수 있게 한다.

- **구체화:** 시스템을 구축하는 관련자의 특정 목표에 따라 상세한 정보를 제공할 수 있게 한다.
